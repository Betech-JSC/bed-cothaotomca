                      ...
                      {socials.map((item, idx) => (
                        item.href && (
                          <a
                            ...
                            className="size-10 rounded-[8px] flex items-center justify-center bg-white text-primary lg:hover:text-secondary lg:hover:bg-yellow duration-300 ease-in-out shadow-sm"
                          >
                            {item.icon}
                          </a>
                        )
