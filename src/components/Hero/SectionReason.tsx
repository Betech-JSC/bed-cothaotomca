          ...
          {items.map((item, index) => (
            <SwiperSlide key={index} className="h-full w-full relative">
              ...
              <div className="max-w-[840px] w-full md:h-full absolute top-20 md:top-0 left-0 flex items-center">
                <div className="md:p-6 p-5 max-md:pb-[5rem] lg:p-10 xl:p-16 md:space-y-4 space-y-6 xl:space-y-6 max-w-[520px] md:max-w-[532px] lg:max-w-[600px] xl:max-w-[620px] w-full max-md:bg-yellow/80 max-md:backdrop-blur-[3px] max-md:rounded-3xl mx-6">
