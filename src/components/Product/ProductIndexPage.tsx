        ...
        <div className="flex flex-col items-center gap-3 md:gap-4">
          ...
          <div className="flex items-center max-lg:justify-between max-lg:w-full">
            ...
            <button
              ...
              className="lg:hidden flex items-center justify-center gap-2 w-[8.3125rem] h-[2.25rem] rounded-[0.75rem] bg-white text-gray-900 font-semibold text-sm shadow-xs shrink-0"
            >
